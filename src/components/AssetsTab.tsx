...
export default function AssetsTab({
  ...
  return (
    <div className="bg-slate-50 min-h-screen pb-24 font-sans text-slate-800">
      ...
      {/* Dedicated Fullscreen Deposit Page View (Compact Spacing) */}
      <AnimatePresence>
        {activeModal === 'deposit' && (
          <motion.div
          ...
          >
            {/* Top Navigation Bar */}
            <header className="bg-white border-b border-slate-200/80 px-4 py-2.5 sm:px-6 flex items-center justify-between sticky top-0 z-30 shadow-2xs">
              <button
                type="button"
                onClick={() => {
                  setActiveModal(null);
                ...
                className="flex items-center gap-1.5 text-slate-700 hover:text-slate-900 px-2 py-1 rounded-xl hover:bg-slate-100 transition cursor-pointer font-bold text-sm"
              >
              ...
              <button
                ...
                className={`px-2.5 py-1 rounded-xl transition cursor-pointer flex items-center gap-1.5 text-xs font-bold ${
                  showDepositHistory
            ...
            {/* Scrollable Content */}
            <main className="flex-1 overflow-y-auto p-2.5 sm:p-4">
              <div className="max-w-md mx-auto w-full pb-8">
                {showDepositHistory ? (
                        ...
                        {historyLogs
                          ...
                          .map((log, idx) => {
                            ...
                            return (
                              <div
                                key={log.id || idx}
                                className="bg-white border border-slate-100 rounded-xl p-3 shadow-2xs space-y-1.5 hover:border-slate-200 transition text-xs"
                              >
                                ...
                                <div className="text-[10px] text-slate-400 font-mono flex items-center justify-between pt-1 border-t border-slate-50">
                  ...
                  <div className="bg-white rounded-2xl p-4 sm:p-5 border border-slate-200/80 shadow-2xs space-y-3">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="font-bold text-slate-800 text-xs sm:text-sm">Deposit Currency</span>
                      <div className="flex items-center gap-1.5 font-bold text-slate-900 text-xs bg-slate-50 px-2.5 py-1 rounded-lg border border-slate-200">
                        <img
                    ...
                    <div className="flex flex-col items-center justify-center my-0.5">
                      <div className="p-2 border-2 border-[#0052d4] rounded-2xl bg-white shadow-xs">
                        <img
                          src={`https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=${recipientAddress}`}
                          alt="Deposit QR Code"
                          className="w-36 h-36 object-contain"
                        />
                      </div>
                      <span className="text-[11px] text-slate-400 font-medium mt-1.5">Scan to Transfer and Deposit</span>
                    </div>

                    {/* Wallet Address Box */}
                    <div className="bg-[#f7f9fc] rounded-xl p-2.5 border border-slate-100 flex items-center justify-between gap-2">
                    ...
                    <div>
                      <label className="block font-bold text-slate-800 text-xs mb-1">Deposit Amount</label>
                      <input
                        type="number"
                        step="any"
                        value={actionAmount}
                        ...
                        className="w-full p-2.5 bg-[#f7f9fc] border border-slate-200 rounded-xl text-sm font-semibold text-slate-800 placeholder-slate-400 focus:outline-none focus:border-[#0052d4] focus:bg-white transition"
                        required
                      />
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-3">
                        <label
                          ...
                          className="w-14 h-14 bg-[#f7f9fc] rounded-xl border border-dashed border-slate-300 hover:border-[#0052d4] flex flex-col items-center justify-center cursor-pointer relative overflow-hidden transition group"
                        >
                          {uploadPreview ? (
                            <img src={uploadPreview} alt="Receipt Screenshot" className="w-full h-full object-cover" />
                          ) : (
                            <Camera className="w-5 h-5 text-slate-300 group-hover:text-[#0052d4] transition" />
                          )}
                          <input
                            id="screenshot-input"
                            type="file"
                    ...
                    <button
                      ...
                      disabled={loading}
                      className="w-full py-3 bg-[#0052d4] hover:bg-blue-600 text-white font-bold text-sm rounded-xl transition shadow-md shadow-blue-500/15 cursor-pointer disabled:bg-blue-300 flex items-center justify-center gap-2"
                    >
                      {loading ? (
                        <>
                    ...
                    <div className="pt-2 border-t border-slate-100 space-y-1.5">
                      ...
                      {officialChannels.map((channel, i) => (
                        <div
                          key={i}
                          className="flex items-center justify-between p-2 bg-slate-50/70 border border-slate-100 rounded-xl hover:bg-slate-100 transition cursor-pointer"
                          onClick={() => {
